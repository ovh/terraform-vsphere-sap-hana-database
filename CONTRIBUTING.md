# Contributing to terraform-vsphere-sap-hana-database
...
terraform-vsphere-sap-hana-database is licensed under a Apache License 2 license. Anything
contributed to terraform-vsphere-sap-hana-database must be released under this license.
